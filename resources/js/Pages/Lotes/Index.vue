...
const columns = [
    ...
    {
        title: "ESQUINA ÁREA VERDE",
        data: "esquina_area",
    },
    {
        title: "ESQUINA ÁREA DE EQUIPAMIENTO",
        data: "esquina_equipamiento",
    },
    {
        title: "AVENIDA ESTRUCTURANTE",
        data: "avenida_estr",
    },
    {
        title: "AVENIDA UNIÓN DE DOS CIUDADES",
        data: "avenida_union",
    },
    {
        title: "SUPERFICE DEL LOTE",
        data: "superficie",
    },
    {
        title: "COSTO AL CONTADO",
        data: "costo_contado",
    },
    {
        title: "COSTO A CRÉDITO",
        data: "costo_credito",
    },
    {
...
const accionesRow = () => {
    // editar
    $("#table-lote").on("click", "button.editar", function (e) {
        e.preventDefault();
    ...
    // eliminar
    $("#table-lote").on("click", "button.eliminar", function (e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let respuesta = await deleteLote(id);
